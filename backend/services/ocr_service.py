...
5. KDV: "KDV", "K.D.V" yazısının yanındaki tutar (sadece sayı+virgül/nokta, TL olmadan)
...
"""
    ...
    def calculate_extraction_score(self, extracted_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # Genel skor (4 ana alan ortalaması)
        score["overall"] = (score["company_name"] + score["invoice_number"] + score["tax_amount"] + score["total_amount"]) / 4
